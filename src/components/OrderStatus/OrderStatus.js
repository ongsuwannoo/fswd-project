    ...
    const orderRender = useMemo(
        () => {
            if(props.status === false){
                return(
                    <div className="grid grid-cols-12 py-8 px-4 lg:px-20 gap-y-8 ">
                        ...
                        <div className="col-span-3">
                            <div className="flex justify-center">
                                <p className="text-xs lg:text-base">ชำระเงินแล้ว</p>
                            </div>
                        </div>
                        <div className="col-span-6"></div>
                        <div className="col-span-3">
                        <div className="flex justify-center">
                                <p className="text-xs lg:text-base">ยกเลิกคำสั่งซื้อ</p>
                            </div>
                        </div>
                    </div>  
        )
